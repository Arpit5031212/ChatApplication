...
GO
PRINT N'Creating Foreign Key [dbo].[FK_UpdatedBy]...';


GO
ALTER TABLE [dbo].[Chats] WITH NOCHECK
    ADD CONSTRAINT [FK_UpdatedBy] FOREIGN KEY ([UpdatedBy]) REFERENCES [dbo].[UserProfiles] ([id]);
...
GO
ALTER TABLE [dbo].[Chats] WITH CHECK CHECK CONSTRAINT [FK_UpdatedBy];
