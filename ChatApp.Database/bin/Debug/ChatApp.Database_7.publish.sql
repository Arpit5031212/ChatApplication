...
GO
/*
The column [dbo].[Chats].[UpdatedBy] is being dropped, data loss could occur.
*/

IF EXISTS (select top 1 1 from [dbo].[Chats])
    RAISERROR (N'Rows were detected. The schema update is terminating because data loss might occur.', 16, 127) WITH NOWAIT

GO
PRINT N'Dropping Foreign Key [dbo].[FK_UpdatedBy]...';


GO
ALTER TABLE [dbo].[Chats] DROP CONSTRAINT [FK_UpdatedBy];


GO
PRINT N'Altering Table [dbo].[Chats]...';


GO
ALTER TABLE [dbo].[Chats] DROP COLUMN [UpdatedBy];
